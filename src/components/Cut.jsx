    ...
    <div>
      <div className='cutPage'>
        <div className='gallery-container'>
               <img className='gallery-images' src={`.${cutObject.galleryImgs[1].img2}`} alt='haircut'></img>
               <img className='gallery-images' src={`.${cutObject.galleryImgs[0].img1}`} alt='haircut'></img>
               <img className='gallery-images' src={`.${cutObject.galleryImgs[1].img2}`} alt='haircut'></img>
               <img className='gallery-images' src={`.${cutObject.galleryImgs[1].img2}`} alt='haircut'></img>
        </div>
